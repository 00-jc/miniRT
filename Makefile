...
MARCH			:=	-march=native
CFLAGS_BASE		:=	-flto -O3 -fno-math-errno -pipe -ffunction-sections -fdata-sections -fvectorize -finline-functions \
					-fvisibility=hidden -fstack-protector-strong -fcf-protection=full -ftrivial-auto-var-init=zero \
					-fno-common -fstack-clash-protection -ffast-math -g3
...
COMMON_OBJ		:=	$(filter-out $(OBJDIR)/main.o,$(OBJS))
